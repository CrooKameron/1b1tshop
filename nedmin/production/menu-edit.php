                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="<?php echo $menuget['menu_seourl'] ?>" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="menu_seourl">
                        </div>
                      </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="menu_status" id="heard" class="form-control" required>
                              <option value="0" <?php if ($menuget['menu_status']==0) { echo 'selected=""'; } ?>> Passive </option>
